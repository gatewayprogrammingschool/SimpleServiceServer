...
Deploy-Package -SolutionDir 'F:\GPS\SimpleServiceServer\GPS.SimpleServiceServer' -BuildDir 'F:\GPS\SimpleServiceServer\GPS.SimpleServiceServer\GPS.SimpleServiceServer\bin\Release' -Namespace "GPS.SimpleServiceServer" -Assembly "GPS.SimpleServiceServer.dll"